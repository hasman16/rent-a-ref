...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_formly_bootstrap__ = __webpack_require__("./node_modules/@ngx-formly/bootstrap/@ngx-formly/bootstrap.es5.js");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__ngx_formly_bootstrap__["a" /* FormlyBootstrapModule */],
...
module.exports = "<div class=\"row\">\n  <div class=\"col-12\">\n    <app-toast [message]=\"toast.message\"></app-toast>\n\n    <div class=\"card\">\n      <div class=\"card form-size\">\n        <form [formGroup]=\"form\" (ngSubmit)=\"onSubmit(model)\">\n          <formly-form [model]=\"model\" [fields]=\"fields\" [options]=\"options\" [form]=\"form\">\n            <button type=\"submit\" class=\"btn btn-primary btn-sm\" [disabled]=\"form.invalid\"><i class=\"fa fa-sign-in\"></i>&nbsp;Login</button>\n            <button class=\"btn btn-link btn-sm\" type=\"button\" (click)=\"forgot()\"><i class=\"fa fa-sign-in\"></i>&nbsp;Forgot Password</button>\n          </formly-form>\n        </form>\n      </div>\n    </div>\n<!--\n    <rar-google-map></rar-google-map> -->\n  </div>\n</div>\n"
...
var EventsComponent = /** @class */ (function () {
    ...
    EventsComponent.prototype.getSports = function () {
        var _this = this;
        this.organizeService.getSports().subscribe(function (sports) {
            _this.sports = sports;
        });
    };
    ...
    EventsComponent.prototype.generateForm = function () {
        var SPORTS = __WEBPACK_IMPORTED_MODULE_5_lodash__(this.sports)
            .map(function (sport) {
            return {
                label: sport.name,
                value: sport.id
            ...
            },
            {
                ...
                fieldGroup: [
                    ...
                    },
                    {
                        ...
                        templateOptions: {
                            label: 'State',
                            options: __WEBPACK_IMPORTED_MODULE_5_lodash__["cloneDeep"](this.states),
                            required: true
                        }
                    },
                    {
    ...
    EventsComponent.prototype.goNewGames = function () {
        this.isEditing = true;
    };
...
var OrganizeComponent = /** @class */ (function () {
    ...
    OrganizeComponent.prototype.getSports = function () {
        this.organizeService.getSports().subscribe(function (sports) {
...
module.exports = "<base-form [fields]=\"fields\" [model]=\"model\" (ngSubmit)=\"onSubmit($event)\">\n\t<hr class=\"space-hr\"/>\n  <button type=\"submit\" class=\"btn btn-primary btn-sm\" [disabled]=\"disable || !baseForm.form.valid\">{{modeName}}</button>\n  <span class=\"spacer\">&nbsp;</span>\n  <button type=\"submit\" class=\"btn btn-danger btn-sm\" title=\"Cancel\" (click)=\"onCancel($event)\">Cancel</button>\n</base-form>\n"
...
var OrganizationFormComponent = /** @class */ (function () {
    function OrganizationFormComponent(statesService) {
        ...
        this.model = {};
        this.modeName = 'Create Organization';
        this.disable = true;
        this.disable = true;
    }
