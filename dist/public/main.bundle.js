...
var EventsComponent = /** @class */ (function () {
    ...
    EventsComponent.prototype.getOptions = function (start, end, step) {
    ...
    EventsComponent.prototype.generateForm = function () {
        var SPORTS = __WEBPACK_IMPORTED_MODULE_5_lodash__(this.sports)
            ...
            .value();
        var refereePay = this.getOptions(30, 101, 5);
        var refereesNeeded = this.getOptions(1, 11, 1);
